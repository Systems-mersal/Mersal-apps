...
export function BrandBanner() {
  ...
  return (
    <View className="mb-4 h-[90px] overflow-hidden rounded-[20px] bg-primaryDark px-5">
      <View className="h-full flex-row items-center justify-between">
        <LocalSvg xml={splashLogoMarkXml} width={56} height={62} />
        <View className="items-end">
          <AppText
            className="text-[28px] text-[#A5D3CE]"
            style={{ fontFamily: fontFamily.bold, lineHeight: 34 }}
          >
            {t("splash:brand-welm")}
          </AppText>
          <AppText
